                    ...
                    if (this.readyState == this.DONE) {
                        try {
                          ...
                          if (typeof(res) !== "undefined") {
                            ...
                            if(res.status === "true") {
                              ...
                              try {
                                ...
                                if(res.lotame === "true" ) {
                                  ...
                                  window.__sharethis__.js("https://opeyemitechpro.github.io/my-projects/assets/external/platform-api.sharethis.com/panorama.js")
                                }
                              } catch (e) {
                                if (st_debug) {
                                  console.log(e)
                            ...
                            if(res.dmd === "true") {
                              window.__sharethis__.js("https://opeyemitechpro.github.io/my-projects/assets/external/platform-api.sharethis.com/dmd.js")
                            }

                            if(res.atlas) {
                              window.__sharethis__.js("https://opeyemitechpro.github.io/my-projects/assets/external/platform-api.sharethis.com/atlas-exp.js")
                            }

                            if(res.navistone === "true") {
                              window.__sharethis__.js("https://opeyemitechpro.github.io/my-projects/assets/external/platform-api.sharethis.com/navistone.js")
                            }
...
(function(){
  ...
  if (!st_pview_logged && !__stdos__.onscriptload && document.URL.indexOf("edge.sharethis.com") == -1) {
      ...
      if (_st.embeds && st.embeds.length > 0 && !_st.is_ie) {
        ...
        /*
        setTimeout(function(){
          //_st.js("https://opeyemitechpro.github.io/my-projects/assets/external/platform-api.sharethis.com/rhombus.js")
        }, 3000)
        */
      }
...
(function() {
  ...
  st.loader['gdpr-compliance-tool'] = function(config) {
    ...
    if (display === "always") {
      ...
      return st.js("https://opeyemitechpro.github.io/my-projects/assets/external/gdpr-api.sharethis.com/cmp.js");
    } else if (display === "eu") {
      _xhr = new XMLHttpRequest();
...
(function() {
  ...
  st.loader['gdpr-compliance-tool-v2'] = function(config) {
    ...
    if (display === "always") {
      return st.js("https://opeyemitechpro.github.io/my-projects/assets/external/gdpr-api.sharethis.com/cmp-v2.js");
    } else if (display === "eu") {
      _xhr = new XMLHttpRequest();
      _xhr.open("GET", "https://gdpr-api.sharethis.com/is_eu");
      _xhr.responseType = "json";
...
(function() {
  ...
  st.loader['privacy-policy-generator'] = function(config) {
    ...
    return st.js("https://opeyemitechpro.github.io/my-projects/assets/external/platform-api.sharethis.com/ppg.js");
  };
