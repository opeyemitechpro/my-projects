    ...
    ???+ code-file "Jenkins Pipeline Script"
        ...
        pipeline {
            ...
            environment {
                ...
                DOCKER_TAG        = 'ver-2.$BUILD_NUMBER' // Docker tag dynamically generated after each build
...
??? warning inline end "Warning"
    ...
    [Learn more :fontawesome-solid-arrow-up-right-from-square:](https://argo-cd.readthedocs.io/en/stable/getting_started/#4-login-using-the-cli){: target="_blank" .md-button}
